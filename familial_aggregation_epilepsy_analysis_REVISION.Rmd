...
## Outcome = Remission (10 year) {.tabset}
...
## Outcome = Remission (5 year) {.tabset}
### EFSCU 
...
## Outcome = Remission (2 year) {.tabset}
...
## Outcome = Treatment Response (1-Year) {.tabset}
...
## Outcome = Treatment Response (2-Year) {.tabset}
...
## Outcome = Treatment Response (3-Year) {.tabset}
